...
//设置集群地址，最好内外IP
var hostArray = []string{"192.168.2.102"}
var localHost = ""
//数量控制接口服务器内网IP，或者getone的SLB内网IP
var GetOneIp = "192.168.2.102"
var GetOnePort = "8084"
var port = "8083"
...
func main() {
	...
	localHost = localIp
	localHost = "192.168.2.102"
	fmt.Println(localHost)


	rabbitMqValidate = rabbitmq.NewRabbitMQSimple("seckill_product")
	...
	//winpty docker run --rm williamyeh/wrk -t80 -c200 -d 60s --latency -H "Cookie: uid=6;sign=aV8f3OqgcTdEiCgenJRIVw==" http://192.168.2.102:8083/check?productID=1
